    ...
    return (
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-[#Fdfdfc]">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <motion.div
                    style={{ y: y1 }}
                    className="absolute -top-20 -left-20 w-[600px] h-[600px] bg-primary-100/50 rounded-full blur-3xl"
                />
                <motion.div
                    style={{ y: y2 }}
                    className="absolute top-1/2 -right-20 w-[500px] h-[500px] bg-accent-100/30 rounded-full blur-3xl"
                />
                <motion.div
                    style={{ y: y3 }}
                    className="absolute bottom-0 left-1/2 w-[800px] h-[400px] bg-primary-100/30 rounded-full blur-3xl transform -translate-x-1/2"
                />
