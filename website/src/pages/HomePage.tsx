...
export default function HomePage() {
  ...
  return (
    <>
      {/* Enhanced SEO Meta Tags with Canonical URL, Robots, and Geo Tags */}
      <SEOHead
        {...seoConfig}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {[
              ...
              <div key={area} className="bg-white rounded-lg p-6 text-center hover:shadow-lg transition-all">
