...
const StMatthewsPage: React.FC = () => {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 3,
        name: 'St. Matthews',
        item: 'https://aaronslawncare.com/areas/st-matthews',
      },
    ],
  };
  ...
  const localBusinessSchema = {
    '@context': 'https://schema.org',
    '@type': 'LocalBusiness',
    '@id': 'https://aaronslawncare.com/areas/st-matthews',
    ...
    url: 'https://aaronslawncare.com/areas/st-matthews',
  ...
  return (
    <>
      <SEOHead
        ...
        canonicalUrl="https://aaronslawncare.com/areas/st-matthews"
            ...
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a
                  ...
                  className="inline-block bg-green-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-green-500 transition-colors"
                >
