...
export const mainNavigation: NavigationItem[] = [
  ...
  { 
    ...
    children: [
      ...
      { label: 'Edging & Trimming', path: '/services/edging' },
      ...
      { label: 'Landscape Maintenance', path: '/services/landscape-maintenance' },
      { label: 'Mulching', path: '/services/mulching' },
      { label: 'Hedge Trimming', path: '/services/hedge-trimming' },
      { label: 'Leaf Removal', path: '/services/leaf-removal' },
      { label: 'Spring Cleanup', path: '/services/spring-cleanup' },
      { label: 'Fall Cleanup', path: '/services/fall-cleanup' },
      ...
      { label: 'Tree Removal', path: '/services/tree-removal' },
    ]
  },
